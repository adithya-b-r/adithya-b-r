...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=28&duration=3000&pause=1000&color=3B82F6&center=true&vCenter=true&width=600&height=80&lines=Real+Full+Stack+Developer+%F0%9F%9A%80;IoT+%26+Electronics+Enthusiast+%E2%9A%A1;Building+Scalable+Solutions+%F0%9F%92%BC)
...
<div align="center">
  ...
  ![Projects](https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=0,2,2,5,3&height=2&section=header)
...
| **📥 Telegram File Bot** | Serverless file management via Telegram | `Telegram API` `Netlify Functions` | ☁️ **Serverless** |
| **🕵️ Admin Panel Finder** | High-performance security scanning tool | `Python` `Threading` | ⚡ **Multi-threaded** |
...
|---------|----------|------------------|
| **⭕ TicTacToe** | AI opponent using Minimax algorithm | `HTML5` `CSS3` `JavaScript` |
...
| **☂️ UmbraVision** | Smart obstacle detection with audio alerts | `Arduino Nano` `Ultrasonic` `Buzzer` | 🎯 **Smart Detection** |
| **🌐 IoT Controller** | Dual relay automation with web interface | `ESP8266` `MQTT` `WebServer` | 🏠 **Home Automation** |
| **🖥️ Digispark Scripts** | USB automation as HID devices | `ATtiny85` `Arduino IDE` | ⚡ **Plug & Play** |
...
<div align="center">
  ...
  ![Wave](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,3,7&height=100&section=footer&animation=twinkling)
